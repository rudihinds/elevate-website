  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 h-full relative pt-6">
      <div className="flex justify-center">
        <div className="h-full flex justify-center items-start flex-col gap-y-4 lg:gap-y-2 xl:ml-20">
          <div className="mx-auto lg:mx-0 px-4 lg:px-0 text-6xl md:text-7xl lg:text-5xl xl:text-6xl font-bold xl:font-bold text-center lg:text-left text-neutral-600 dark:text-neutral-300 shadow-2xl w-full mb-6 xl:mb-4   ">
            Put your systems <br /> on autopilot with AI
          </div>
          <div className="flex w-full text-center mb-10 text-xl xl:text-2xl lg:text-left md:justify-center lg:justify-start">
            <p className="md:w-4/6 lg:w-5/6 px-16 lg:px-0">
              {/* <p className="flex w-full md:w-1/2 lg:w-2/3 text-sm md:text-xl mb-10 text-center xl:text-left mx-auto md:mx-0"> */}
              Automate your workflows, time-consuming tasks, and elevate your
              business.
            </p>
          </div>
